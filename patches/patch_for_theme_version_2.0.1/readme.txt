...
Version 2.0.1:
Added:
- Update homepage layout: Home Christmas



HOW TO APPLY THIS PATCH:

- Upload two folders app and pub in patch_for_theme_version_2.0.1 to magento root on your server, override old files then connect to ssh, navigate to magento root and run the following commands:
...
If you want to use Home Christmas, you can import Themes\Magento_2\Version_2\Homepage Demo\Home_Christmas.xml
