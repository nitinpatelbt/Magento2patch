...
class ProductPageLayout implements \Magento\Framework\Option\ArrayInterface
{
    ...
    public function toOptionArray()
    {
        return [
            ...
            ['value' => 'themesetting_product_with_sticky_info', 'label' => __('Product with sticky info')],
            ['value' => 'themesetting_product_with_sticky_info_2', 'label' => __('Product with sticky info 2')],
        ];
    }
}
